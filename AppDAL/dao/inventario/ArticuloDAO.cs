...
namespace pe.com.sil.dal.dao
{
  public class ArticuloDAO
  {
      ...
      const string C_STOCK1 = "SELECT dbo.FND_ObtenerStockArticulo1(@id_articulo, @id_proyecto, @lote, @fvencimiento)";
      ...
      public Decimal Stock1(int IdArticulo, int IdProyecto, string Lote, DateTime fvencimiento)
      {
          Database db = DatabaseFactory.CreateDatabase("ApplicationConnectionString");
          DbCommand dbCommand = db.GetSqlStringCommand(C_STOCK1);
          db.AddInParameter(dbCommand, "@id_articulo", DbType.Int32, IdArticulo);
          db.AddInParameter(dbCommand, "@id_proyecto", DbType.Int32, IdProyecto);
          db.AddInParameter(dbCommand, "@lote", DbType.String, Lote);
          db.AddInParameter(dbCommand, "@fvencimiento", DbType.DateTime, fvencimiento);
          Decimal r = Convert.ToDecimal(db.ExecuteScalar(dbCommand));
          return r;
      }
