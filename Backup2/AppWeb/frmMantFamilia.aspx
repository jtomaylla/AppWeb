<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="frmMantFamilia.aspx.cs" Inherits="AppWeb.frmMantFamilia" %>
...
<div class="cssTituloPagina">Mantenimiento de Familia</div>
...
<asp:Panel ID="panLista" runat="server">
    ...
    <Columns>
        <asp:BoundField ReadOnly="True" DataField="IdFamilia" HeaderText="Id" ItemStyle-Width="50px"></asp:BoundField>
        <asp:BoundField ReadOnly="True" DataField="CodFamilia" HeaderText="Código" ItemStyle-Width="100px"></asp:BoundField>
        <asp:BoundField ReadOnly="True" DataField="NombreFamilia" HeaderText="Descripción" ItemStyle-Width="500px"></asp:BoundField>
...
<asp:Panel ID="panRegistro" runat="server">
    ...
    <div class="cssTablaRegistro">
        ...
        <tr>
            <td>Codigo</td>
            <td>:</td>
            <td><asp:TextBox ID="txtCodigo" runat="server"  MaxLength="4" Width="40px"></asp:TextBox></td>
        </tr>
        <tr>
            <td>Descripcion</td>
            <td>:</td>
