<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="frmOrdenCompraEnvioProveedor.aspx.cs" Inherits="AppWeb.frmOrdenCompraEnvioProveedor" %>
...
<div class="cssTituloPagina">Ordenes de Compra Pendiente de Envio al Proveedor</div>
...
>
    ...
    <Columns>
        ...
        <asp:TemplateField ShowHeader="True" HeaderText="">
            <ItemTemplate>
                <asp:Button ID="btnLineas" runat="server" Text="Enviar O/C" 
