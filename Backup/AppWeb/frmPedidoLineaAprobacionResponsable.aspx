<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="frmPedidoLineaAprobacionResponsable.aspx.cs" Inherits="AppWeb.frmPedidoLineaAprobacionResponsable" %>
...
<br />
<asp:Button ID="btnEnviarAprobar" runat="server" Text="Enviar a Aprobar"  CssClass="cssButton" onclick="btnEnviarAprobar_Click"  />
