...
namespace AppWeb
{
    public partial class frmOrdenCompraAprobacionLogistica : System.Web.UI.Page
    {
        ...
        {
            List<OrdenCompraDTO> objLista = objOrdenCompraDAO.ListarAprobacionLogistica();
        ...
        protected void gvLista_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            ...
            if (e.CommandName == "Seleccionar")
            {
                ...
                Response.Redirect("frmOrdenCompraLineaAprobacionLogistica.aspx");
            }
