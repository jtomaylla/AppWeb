...
namespace AppWeb
{
    public partial class frmPreArticuloSolicitud : System.Web.UI.Page
    {
        ...
        protected void InicializaPagina()
        {
            ...
            //PROYECTO
            List<ProyectoDTO> objProyectoLista = objProyectoDAO.Listar(objUsuario.IdUsuario);
        ...
        protected void Listar()
        {
            ...
            try
            {
                obj = objArticuloDAO.Listar(objUsuario.IdUsuario);
