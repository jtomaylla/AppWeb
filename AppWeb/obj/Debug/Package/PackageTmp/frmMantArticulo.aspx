<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="frmMantArticulo.aspx.cs" Inherits="AppWeb.frmMantArticulo" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <div class="cssTituloPagina">Mantenimiento de Artículos</div>
...
<asp:Panel ID="panRegistro" runat="server">
    ...
    <div class="cssTablaRegistro">
        ...
        <tr>
            ...
            <td>:</td>
            <td><asp:TextBox ID="txtCodigoArticulo" runat="server" Width="200px" MaxLength="13"></asp:TextBox></td>
        </tr>
        <tr>
            <td>Unidad Medida</td>
            <td>:</td>
        ...
        <tr>
            <td>Tiempo Util</td>
            <td>:</td>
            <td><asp:TextBox ID="txtTiempo" runat="server" Width="100px" Text="0" Enabled="false"></asp:TextBox></td>
        </tr>
        <tr>
            <td>Modelo</td>
            <td>:</td>
        ...
        <table>
            ...
            <td>
                <asp:Button ID="btnAsignaProyecto" runat="server" Text="Asignar" CssClass="cssButton"
                    onclick="btnAsignaProyecto_Click" />
            </td>
            </tr>
        </table>
    ...
    <asp:gridview id="gvProyecto" runat="server" 
        autogeneratecolumns="False"
    ...
    <PagerStyle CssClass="gridview_pager"></PagerStyle>
    <Columns>
        <asp:BoundField ReadOnly="True" DataField="NombreProyecto" HeaderText="Proyecto" ItemStyle-Width="500px"></asp:BoundField>
        <asp:TemplateField ShowHeader="False">
            <ItemTemplate>
                <asp:Button ID="btnEliminar" runat="server" Text="Retirar" 
                    CommandName="Eliminar" 
                    CausesValidation="False" 
                    CommandArgument = '<%# Bind("IdProyecto") %>'
                    CssClass="cssButton" />
            </ItemTemplate>
        </asp:TemplateField>
    </Columns>
