...
namespace AppWeb
{
    public partial class frmOrdenCompraLineaEnvioProveedor : System.Web.UI.Page
    {
        ...
        protected void InicializaPagina()
        {
            ...
            this.ddlDireccion.Items.Clear();

            List<SedeDTO> ListaSede;
            try
            {
                ListaSede = objSedeDAO.Listar();
                this.ddlDireccion.DataSource = ListaSede;
                this.ddlDireccion.DataTextField = "Direccion";
                this.ddlDireccion.DataValueField = "IdSede";
                this.ddlDireccion.DataBind();
                this.ddlDireccion.Items.Insert(0, new ListItem("- Seleccione -", "0"));
            }
            catch (Exception err)
            {
                throw (err);
        ...
        protected void btnAprobar_Click(object sender, EventArgs e)
        {
            ...
            //int IdSede = Convert.ToInt32(ddlDireccion.SelectedValue);
            ...
            obj.IdSede = Convert.ToInt32(ddlDireccion.SelectedValue);
            //
