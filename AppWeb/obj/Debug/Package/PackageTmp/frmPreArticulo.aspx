<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="frmPreArticulo.aspx.cs" Inherits="AppWeb.frmPreArticulo" %>
...
<div class="cssTituloPagina">Solicitudes de Creación de Artículos (Inventario)</div>
...
<asp:Panel ID="panRegistro" runat="server">
    ...
    <div class="cssTablaRegistro">
        ...
        <tr>
            ...
            <td>:</td>
            <td><asp:TextBox ID="txtCodigoArticulo" runat="server" Width="200px"></asp:TextBox></td>
        </tr>
        <tr>
            <td>Unidad Medida</td>
            <td>:</td>
        ...
        <asp:Button ID="btnCrearArticulo" runat="server" CssClass="cssButton" 
            Text="Crear Articulo" onclick="btnCrearArticulo_Click" />
