...
namespace AppWeb
{
    public partial class frmPedidoAprobacionResponsable : System.Web.UI.Page
    {
        ...
        protected void InicializaPagina()
        {
            ...
            //listar lineas
            List<PedidoDTO> objPedidoLista = objPedidoDAO.ListarPorAprobacionResponsable(Convert.ToInt32(txtIdUsuario.Text));
        ...
        protected void gvPedidoLista_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            ...
            if (e.CommandName == "Seleccionar")
            {
                ...
                Response.Redirect("frmPedido.aspx?accion=edit&form=resp");
            }
        }
        ...
        private List<ListItem> ListaColumnas()
        {
            ...
            columnavalores.Add(new ListItem("Descripción", "dat#Descripcion"));
