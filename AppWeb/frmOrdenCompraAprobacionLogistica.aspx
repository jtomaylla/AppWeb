<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="frmOrdenCompraAprobacionLogistica.aspx.cs" Inherits="AppWeb.frmOrdenCompraAprobacionLogistica" %>
...
<div class="cssTituloPagina">Ordenes de Compra Pendiente de Aprobar</div>
...
>
    ...
    <Columns>
        ...
        <asp:TemplateField ShowHeader="True" HeaderText="">
            <ItemTemplate>
                <asp:Button ID="btnLineas" runat="server" Text="Aprobar O/C" 
