<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="frmGuiaRemisionPendiente.aspx.cs" Inherits="AppWeb.frmGuiaRemisionPendiente" %>
...
<div class="cssTituloPagina">Despacho de pedido interno</div>
...
<tr>
    <td>
        <asp:Label ID="lblTipoDespacho" runat="server" Text=""></asp:Label></td>
    <td>:</td>
    <td>
        <asp:TextBox ID="txtIdDespacho" runat="server" ReadOnly="true"></asp:TextBox>
    </td>
</tr>
