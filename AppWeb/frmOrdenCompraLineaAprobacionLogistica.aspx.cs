...
namespace AppWeb
{
    public partial class frmOrdenCompraLineaAprobacionLogistica : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            this.btnAprobar.OnClientClick = "return js_validar_aprobar();";
        ...
        protected void Actualizar() 
        {
            ...
            {
                lblError.Text = "Seleccione Fecha de entrega";
                return;
            }

            if (ddlFormaPago.SelectedIndex == 0 || ddlFormaPago.SelectedIndex == -1)
            {
                lblError.Text = "Seleccione Forma de pago";
                return;
            }*/
            ...
            //CESAR BOCANEGRA
            objOrdenCompraDTO.NroCotizProv = this.txtNroCotizacionP.Text.Trim();
