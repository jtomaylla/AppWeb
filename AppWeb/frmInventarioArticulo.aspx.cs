...
namespace AppWeb
{
    public partial class frmInventarioArticulo : System.Web.UI.Page
    {
        ...
        protected void btnKardex_Click(object sender, EventArgs e)
        {
            ...
            List<InvTransaccionDTO> objTransaccionLista = new List<InvTransaccionDTO>();
            if (ddlProyecto.SelectedIndex != 0 && txtArticulo.Text.Trim() != "")
            {
                objTransaccionLista = objTransaccionDAO.ListarPorArticuloProyecto(Convert.ToInt32(this.txtIdArticulo.Text), Convert.ToInt32(this.ddlProyecto.SelectedValue));
                lblMensaje.Text = "";
            }
            else
            {
                this.lblMensaje.Text = "Seleccione proyecto y articulo";
                return;
            }
